...
public class PapagoTranslationApi implements ApiClass{
    ...
    public String getApi(String args,String tbtn) throws InterruptedException {
        ...
        th = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Tvalue = post(apiURL, requestHeaders, text,tbtn);
    ...
    public String post(String apiUrl, Map<String, String> requestHeaders, String text,String tbtn) {
        ...
        String postParams = "source="+ tbtn+ "&target=ko&text=" + text; //원본언어: 한국어 (ko) -> 목적언어: 영어 (en)
